            ...
            <>
                <div className="container overflow-hidden" style={{ minHeight: "100vh" }}>
                    ...
                    <form className="mb-5">
                        ...
                        <div className="form-group row mt-3 justify-content-center">
                            <label htmlFor="beganPractice" className="col-2 col-form-label">Began Practice</label>
                            <div className="col-5">
                                <input type="date" id="beganPractice" className="form-control" name="beganPractice" value={this.state.beganPractice} onChange={this.onChange} required />
                                {console.log(this.state.beganPractice)}
                            </div>
                        </div>
                        <div className="form-group row mt-3 justify-content-center">
