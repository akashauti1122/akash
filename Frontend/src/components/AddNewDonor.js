...
class AddNewDonor extends Component {
    ...
    validateMobileNumber() {
        ...
        if (number.length != 10 || number == NaN) {
                ...
                <div className="container overflow-hidden" style={{ minHeight: "100vh" }}>
                    ...
                    <form>
                        ...
                        <div className="form-group row my-3 justify-content-center">
                            ...
                            <div className="col-5">
                                <input type="email" id="email" className="form-control" placeholder="e.g. abc@xyz.com" name="email" value={this.state.email} onChange={this.onChange} required onBlur={this.removeWarnings} onFocus={this.validateEmail} /><span style={{ color: 'red' }} id='emailVr'></span>
                            </div>
                        </div>
                        ...
                        <div className="form-group row mt-3 justify-content-center">
                            <label htmlFor="unitsOfBlood" className="col-2 col-form-label">Units of Blood</label>
                            <div className="col-5">
                                <input type="number" id="unitsOfBlood" min="0" className="form-control" name="unitsOfBlood" value={this.state.unitsOfBlood} onChange={this.onChange} />
                            </div>
                        </div>
