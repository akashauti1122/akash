                                    ...
                                    this.state.appointments.map(
                                        (appointment, index) =>
                                            <tr key={appointment.id}>
                                                ...
                                                <td>
                                                    <button className="btn btn-danger" onClick={() => { this.cancelAppointment(appointment.id) }}>Cancel</button>
                                                    <NavLink className="btn btn-info btn-link text-dark text-decoration-none offset-1" to={{ pathname: '/patient-details-for-doctor', state: { appointmentId: appointment.id } }}>Patient Details</NavLink>
                                                </td>
                                            </tr>
                                    )
                                }
