...
public class BloodDonor extends BaseEntity {
	...
	public BloodDonor(String name, String email, String contactNumber, BloodGroup bloodGroup, Integer unitsOfBlood,
	...
	public void setUnitsOfBlood(Integer unitsOfBlood) {
		this.unitsOfBlood = unitsOfBlood;
	}
	...
	public String toString() {
		return "BloodDonor [name=" + name + ", email=" + email + ", contactNumber=" + contactNumber + ", bloodGroup="
				+ bloodGroup + ", unitsOfBlood=" + unitsOfBlood + ", city=" + city + ", state=" + state + "]";
	}
}
