...
public class DoctorServiceImpl implements DoctorServiceIntf {
	...
	public Doctor saveDoctor(DoctorDTO doctor) {
		...
		System.out.println("*** DrDTO : "+doctor);
		System.out.println("**** began dto : "+doctor.getBeganPractice());
		...
		System.out.println("**** began practice : "+newDoctor.getBeganPractice());
	...
	public Doctor updateDoctorDetails(DoctorDTO detachedDoctor, Long id) {
		...
		BeanUtils.copyProperties(id, doctor, getNullPropertyNames(doctor));
